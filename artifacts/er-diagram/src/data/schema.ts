export const erSchema = {
  ...
  relationships: [
    {
      from: "sales_master.clientid",
      to: "tblcompanies.userid",
      type: "many-to-one",
    },
    {
      from: "sales_items.salesorderid",
      to: "sales_master.id",
      type: "many-to-one",
    },
    {
      from: "sales_items.warehouse",
      to: "tblmasterwarehouse.id",
      type: "many-to-one",
    },
    {
      from: "sales_items.inventory_id",
      to: "master_inventory.id",
      type: "many-to-one",
    },
  ],
};
